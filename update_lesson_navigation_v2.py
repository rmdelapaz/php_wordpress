...
def main():
    ...
    # Try different path formats to find the one that works
    possible_paths = [
        r"\\wsl$\Ubuntu\home\practicalace\projects\php_wordpress\01module",
        r"\\wsl.localhost\Ubuntu\home\practicalace\projects\php_wordpress\01module",
        r"\\\\wsl$\Ubuntu\home\practicalace\projects\php_wordpress\01module",
    ...
    for path_str in possible_paths:
        ...
        if test_path.exists() and test_path.is_dir():
            ...
            print(f"Found module directory at: {path_str}")
            break
    
    if module_path is None:
        print("Error: Could not find the 01module directory.")
        print("Tried the following paths:")
        for path_str in possible_paths:
            print(f"  - {path_str}")
        print("\nPlease run this script from the php_wordpress directory")
        print("or update the script with the correct path.")
        return
